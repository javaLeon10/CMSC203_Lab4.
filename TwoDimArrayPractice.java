...
//key = value;
	   ...
	   for ( int j = 0; j < intArray[0].length; j++ )
       {
         intArray[rowSelected][j] = value;
         animate(rowSelected,j);
       }
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
       ...
       {
         if (intArray[j][myColumn] < myMin) {
        	 myMin = intArray[myColumn][j];
         }
         animate(j,myColumn,myMin);
       }
      return myMin; // replace this line with your return statement
   }
	   ...
	   for ( int i = 0; i < intArray.length; i++ )
	      {
	        ...
	        for ( int j = 0; j < intArray[i].length; j++ )
	        {
	        	if (intArray[i][j] == myValue) numTimes++;
	        
	        }
	        //System.out.println( );
	      }

     return numTimes; // replace this line with your return statement
   }
